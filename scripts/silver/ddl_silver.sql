...
DROP TABLE IF EXISTS silver_symbols;
CREATE TABLE IF NOT EXISTS silver_symbols(
...
COPY silver.silver_symbols(commodity_name, symbol)
FROM '/commodity-tracker/data/symbols.csv'
DELIMITER ','
CSV HEADER;
